...
import { appIconXMark } from "@/components/icons/definitions.generated";
...
export default function RouteLoadingSplash({
  ...
  return (
    <div className="absolute inset-0 z-[60] bg-white/88 px-6 backdrop-blur-sm">
      {onCancel ? (
        <div className="pointer-events-none absolute left-0 right-0 top-0 px-6 pt-6">
          <div className="mx-auto flex w-full max-w-xs justify-end">
            <button
              type="button"
              onClick={onCancel}
              className="pointer-events-auto flex h-10 w-10 items-center justify-center text-dg-gray-600 transition-colors active:text-dg-black"
              aria-label="돌아가기"
            >
